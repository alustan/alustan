...
docker pull alustan/web-app-demo:0.1.0

# Tag the images
docker tag alustan/example:0.31.0 "$DOCKER_USERNAME"/example:0.31.0
docker tag alustan/web-app-demo:0.1.0 "$DOCKER_USERNAME"/web-app-demo:0.1.0

# Push the images to your registry
docker push "$DOCKER_USERNAME"/example:0.31.0
docker push "$DOCKER_USERNAME"/web-app-demo:0.1.0
