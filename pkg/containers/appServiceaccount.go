...
// CreateOrUpdateAppServiceAccountAndRoles creates or updates a namespace, ServiceAccount, ClusterRole, and ClusterRoleBinding for the specified namespace.
// It returns the ServiceAccount name and any error encountered.
func CreateOrUpdateAppServiceAccountAndRoles(logger *zap.SugaredLogger, clientset kubernetes.Interface,  namespace string) (string, error) {
	saIdentifier := "argo-app-sa"
	roleIdentifier := "argo-app-sa-role"
